...
$sql = "create table if not exists facility(id int not null auto_increment primary key, featuree varchar(100),
titlee varchar(50),
majorr varchar(20),
datee varchar(300),
costt varchar(50),
facilityy varchar(20),
logoo varchar(300),
facilitiess varchar(50),
snapchatt varchar(20),
hardwaree varchar(300),
inchargee varchar(300),
inchargee2 varchar(50),
inchargee3 varchar(20),
inchargee4 varchar(300)
)";
$result = mysqli_query($conn, $sql);
...
if (isset($_POST['submit'])) {
    ...
    $sql ="insert into facility(featuree,titlee,majorr,datee,costt,faclityy,logoo,facilitiess,snapchatt,hardwaree,inchargee,inchargee2,inchargee3,inchargee4) values('$feature','$title','$major','$date','$cost','$facility','$logo','$facilities','$snapchat','$hardware','$incharge','$incharge2','$incharge3','$incharge4')";
    ...
    $result = mysqli_query($conn, $sql);
        if ($result){  
          try{
              ...
              $t1 = $action.",inserted facility";
              $t2 = $form.", facility form";
              ...
              echo '<div class="alert alert-success alert-dismissable" id="flash-msg" style="margin-top:70px">
                  <h4>facility added successfully</h4>
              </div>';
          } 
          catch(e)
          {
