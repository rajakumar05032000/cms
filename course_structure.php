...
<body>
    <div class="container-login100" style="background-image: url('images/img-01.jpg');">
        <div class="container card col-md-4 ">
            ...
            <center><h1>Course Structure</h1></center>
            ...
            <div class="row">
                <div class="col ms-3">
                    <label for="name" class="form-label mt-3 col-md-7 mb-3 ">Text</label>
                    <textarea class="form-control mb-3 me-3" id="text" name="text" rows="3" ><?php echo $text?></textarea>
                </div>
            </div>
