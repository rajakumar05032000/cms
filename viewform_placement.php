...
?>
<h2 class="ms-3 mt-3"><b>Placement</b></h2>
    <div class="main-card m-3 card min-vh-75"  style="min-height:55%">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2   ">
                                <input type="button" class="btn btn-primary" name ="insert" value="insert" onclick="window.location.href='placement.php'">
                            </div>
                            ...
                            <table class="mb-0 table table-hover" id="myTable">
                             ...
                             <?php
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="update_placement.php?id=<?php echo $row['id'] ?>"><i class="bi bi-pencil-square"></i></a>
                                        <a href="deleteplacement.php?id=<?php echo $row['id'] ?>"> <i class="bi bi-trash p-3 "></i></a>
                                    </td>
