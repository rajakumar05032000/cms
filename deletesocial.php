...
$sql = "delete from social where id='$del_id'";
$result = mysqli_query($conn,$sql);

if($result)
{
    echo "<script>alert('social Deleted Successfully')</script>";
    header("Location: viewform_social.php");
}
...
{  
    try{
        ...
        echo '<div class="alert alert-success alert-dismissable" id="flash-msg" style="margin-top:70px">
            <h4>social deleted successfully</h4>
        </div>';
    } 
    catch(e)
    {
