...
$sql = "delete from departmentdata where id='$del_id'";
$result = mysqli_query($conn,$sql);

if($result)
{
    echo "<script>alert('departmentdata Deleted Successfully')</script>";
    header("Location: viewform_department.php");
}
...
{  
    try{
        ...
        $t1 = $action.",deleted department";
        $t2 = $form.", departmemt form";
        ...
        echo '<div class="alert alert-success alert-dismissable" id="flash-msg" style="margin-top:70px">
            <h4>department deleted successfully</h4>
        </div>';
    } 
    catch(e)
    {
