...
?>
                            <h2 class="ms-3 mt-3"><b> Course-View</b></h2>
                            ...
                            <div class="col-md-2 mt-3 ">
                                <input type="button" class="btn btn-primary float-right " name ="Insert" value="Insert" onclick="window.location.href='insert_course.php'">
                            </div>
                            ...
                            <table class="mb-0 table table-hover" id="myTable">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="update_course.php?id=<?php echo $row['id'] ?>"><i class="bi bi-pencil-square"></i></a>
                                        <a href="deletecourse.php?id=<?php echo $row['id'] ?>"> <i class="bi bi-trash p-3 "></i></a>
                                    </td>
