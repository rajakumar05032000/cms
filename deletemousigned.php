...
$sql = "delete from mousigned where id='$del_id'";
$result = mysqli_query($conn,$sql);

if($result)
{
    echo "<script>alert('mousigned Deleted Successfully')</script>";
    header("Location: viewform_mousigned.php");
}
...
{  
    try{
        ...
        echo '<div class="alert alert-success alert-dismissable" id="flash-msg" style="margin-top:70px">
            <h4>mousigned deleted successfully</h4>
        </div>';
    } 
    catch(e)
    {
